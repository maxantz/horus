...
class MachineSettingsDialog(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        hbox.Add(self.machineShapeCombo, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        ...
        self.diam_hbox.Add(self.diameterField, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        ...
        self.width_hbox.Add(self.widthField, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        vbox.Add(self.width_hbox, 0, wx.ALL | wx.EXPAND, 10)
        # Height
        hbox = wx.BoxSizer(wx.HORIZONTAL)
        hbox.Add(self.heightLabel, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL, 10)
        hbox.AddStretchSpacer()
        hbox.Add(self.heightField, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        ...
        self.depth_hbox.Add(self.depthField, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        ...
        hbox.AddStretchSpacer()
        hbox.Add(self.machineModelField, 0, wx.RIGHT | wx.ALIGN_CENTER_VERTICAL)
        vbox.Add(hbox, 0, wx.ALL | wx.EXPAND, 10)
        vbox.Add(wx.StaticLine(self), 0, wx.EXPAND | wx.ALL, 5)
